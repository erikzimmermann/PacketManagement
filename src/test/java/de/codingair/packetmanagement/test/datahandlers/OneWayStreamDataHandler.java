...
public class OneWayStreamDataHandler extends OneWaySingleConnectionStreamDataHandler {
    public OneWaySingleConnectionStreamDataHandler other;

    public OneWayStreamDataHandler() {
